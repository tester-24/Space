...
Mobile.getText(findTestObject('Object Repository/LoginRepo/Wait-Element-Holding'), 0)
...
Mobile.getText(findTestObject('Object Repository/LoginRepo/Holding-Share-Verify'), 1000)
