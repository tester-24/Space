...
Mobile.tap(findTestObject('Object Repository/LoginRepo/dividend Click'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tap(findTestObject('Object Repository/LoginRepo/Dividend Share Verify'), 1000)
