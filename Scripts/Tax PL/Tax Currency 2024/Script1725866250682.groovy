...
Mobile.tap(findTestObject('Object Repository/LoginRepo/Tax Currency Click'), 1000)

Mobile.tap(findTestObject('Object Repository/LoginRepo/Ledger-Share'), 1000)

Mobile.tap(findTestObject('Object Repository/LoginRepo/Tax Share Verify'), 1000)
