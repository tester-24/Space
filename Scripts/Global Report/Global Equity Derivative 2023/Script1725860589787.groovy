...
Mobile.tap(findTestObject('Object Repository/LoginRepo/Global Derivative Click'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Object Repository/LoginRepo/Ledger-Share'), 100)

Mobile.getText(findTestObject('Object Repository/LoginRepo/Global Share Verify'), 100)
...
Mobile.tap(findTestObject('Object Repository/LoginRepo/Download-ToastMsg'), 100)

Mobile.tap(findTestObject('Object Repository/LoginRepo/Ledger-Mail-Send'), 0)

Mobile.tap(findTestObject('Object Repository/LoginRepo/Ledger-ToastMsg'), 100)