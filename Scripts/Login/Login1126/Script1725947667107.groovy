...
Mobile.setText(findTestObject('Object Repository/LoginRepo/Enter id'),'1126', 0); //m3903

Mobile.setText(findTestObject('Object Repository/LoginRepo/Enter pass'),'Jainam@1234', 0); //Nirav@789
